      ...
      >
        ...
        <div className="flex gap-5 flex-wrap my-5">
          <a href="https://amazing-toffee-71729d.netlify.app">
            ...
            >
              <img src={project1} className="rounded-lg transition delay-150" />
              <div>
                <h1
                ...
                >
                  E-commerce Clothing Website (Tailwind,Reactjs,Firebase)
                </h1>
              </div>
            </div>
          </a>
          ...
          <a href="https://amazing-toffee-71729d.netlify.app">
            ...
            >
              <img src={project2} className="rounded-lg transition delay-150" />
              <div>
                <h1
                  className={`text-md font-bold ${
                    bgcolor === "white" ? "text-black" : "text-white"
                ...
                >
                  Portfolio Website (Tailwind,javascript,Reactjs)
                </h1>
              </div>
            </div>
          </a>
          <a href="https://amazing-toffee-71729d.netlify.app">
            ...
            >
              <img src={project3} className="rounded-lg transition delay-150" />
              <div>
                <h1
                  className={`text-md font-bold ${
                    bgcolor === "white" ? "text-black" : "text-white"
                ...
                >
                  Text Data Handeling (Bootstrap,javascript,Reactjs)
                </h1>
              </div>
            </div>
          </a>
