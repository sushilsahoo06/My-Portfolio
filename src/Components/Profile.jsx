...
import sushil from "./SocialLinks/sushil.jpg";
import "../Components/Global.css";
import cv from "../Components/SocialLinks/sushil_Resume.pdf";
      ...
      <div className="w-full flex justify-around">
        ...
        >
          <div className="w-40 h-40 rounded-full  image">
            <img src={sushil} className="w-screen rounded-lg" />
          </div>
          <h1
          ...
          <div className=" w-96 p-2 flex gap-2 justify-center relative lg:top-10 sm:top-14">
            ...
            >
              <a href="https://www.instagram.com/reels/DFE4FExITp2/?hl=en" target="#">
                {" "}
            ...
            >
              <a href="https://www.linkedin.com/in/sushil-sahoo-982716271/">
                {" "}
            ...
            >
              <a href="https://github.com/sushilsahoo06" target="#">
                {" "}
